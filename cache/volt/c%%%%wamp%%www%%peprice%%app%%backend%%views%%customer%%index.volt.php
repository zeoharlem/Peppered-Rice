...
<body class="page-user">
  ...
  <nav role="navigation" class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega">
    ...
    <div class="navbar-header">
      ...
      <div data-toggle="gridmenu" class="navbar-brand navbar-brand-center site-gridmenu-toggle">
        <img title="Remark" src="<?= $this->url->get('assets/images/logo.png') ?>" class="navbar-brand-logo">
    ...
    <div class="navbar-container container-fluid">
      ...
      <div id="site-navbar-collapse" class="collapse navbar-collapse navbar-collapse-toolbar">
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a href="javascript:void(0)" class="thumbnail margin-0">
                            <img alt="..." src="<?= $this->url->get('assets/photos/placeholder.png') ?>" class="width-full">
                          </a>
                        </li>
                        <li>
                          <a href="javascript:void(0)" class="thumbnail margin-0">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li>
            <a role="button" data-animation="slide-bottom" aria-expanded="false" title="Log Out" href="<?= $this->url->get('backend/logout/') ?>">
  ...
  <div class="site-menubar">
        ...
        <div>
          <ul class="site-menu">
            ...
            <li class="site-menu-item">
              <a data-slug="dashboard" href="<?= $this->url->get('backend/dashboard/') ?>">
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a data-slug="page-faq" href="<?= $this->url->get('backend/products/category') ?>" class="animsition-link">
                    <i aria-hidden="true" class="site-menu-icon "></i>
                    <span class="site-menu-title">Product Categories</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a data-slug="page-register" href="<?= $this->url->get('backend/products/show') ?>" class="animsition-link">
                    <i aria-hidden="true" class="site-menu-icon "></i>
                    <span class="site-menu-title">Create Products</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a data-slug="page-login" href="<?= $this->url->get('backend/products/subcategory') ?>" class="animsition-link">
                    <i aria-hidden="true" class="site-menu-icon "></i>
                    <span class="site-menu-title">Create Sub Category(ies)</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a data-slug="page-lockscreen" href="<?= $this->url->get('backend/products') ?>" class="animsition-link">
                    <i aria-hidden="true" class="site-menu-icon "></i>
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item active">
                  <a data-slug="forms-general" href="<?= $this->url->get('backend/order/show') ?>" class="animsition-link">
                    <i aria-hidden="true" class="site-menu-icon "></i>
                    <span class="site-menu-title">Order Now</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a data-slug="forms-material" href="<?= $this->url->get('backend/order/') ?>" class="animsition-link">
                    <i aria-hidden="true" class="site-menu-icon "></i>
                    <span class="site-menu-title">Manage Order(s)</span>
                  </a>
                </li>
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                ...
                <li class="site-menu-item">
                  <a data-slug="chart-c3" href="<?= $this->url->get('backend/shops/manage') ?>" class="animsition-link">
                    <i aria-hidden="true" class="site-menu-icon "></i>
    ...
    <div class="site-menubar-footer">
      ...
      <a data-original-title="Lock" data-toggle="tooltip" data-placement="top" href="<?= $this->url->get('backend/lock/') ?>">
        <span aria-hidden="true" class="icon wb-eye-close"></span>
      </a>
      <a data-original-title="Logout" data-toggle="tooltip" data-placement="top" href="<?= $this->url->get('backend/logout/') ?>">
...
<div role="tabpanel" id="all_contacts" class="tab-pane active">
                <ul class="list-group">
                <?php foreach ($customers as $keys => $values) { ?>
                  <li class="list-group-item">
                    <div class="media">
                      <div class="media-left">
                        <div class="avatar avatar-online">
                          <img alt="..." src="<?= $this->url->get('assets/images/default-avatar.jpg   ') ?>">
                          <i class="avatar avatar-busy"></i>
                        </div>
                      </div>
                      <div class="media-body">
                        <h4 class="media-heading">
                          <?= Phalcon\Text::upper($values->firstname) . ' ' . Phalcon\Text::upper($values->lastname) ?>
                          <small>Last Access: 1 hour ago</small>
                        </h4>
                        <p>
                          <i aria-hidden="true" class="icon icon-color wb-map"></i>                          <?= ucwords($values->address) ?>
                        </p>
                        <div>
                ...
                <?php if ($paginator->total_pages > 1) { ?>
                    <?php $controller = Phalcon\Text::lower($this->view->getControllerName()); ?>
                    <?php $action = Phalcon\Text::lower($this->view->getActionName()); ?>
                    <?php $startIndex = 1; $q = trim($search_query); ?>
                    <?php if ($paginator->total_pages > 5) { ?>
                        <?php if ($paginator->current > 3) { ?>
                            <?php $startIndex = $startIndex + $paginator->current - 3; ?>
                        <?php } ?>
                        <?php if ($paginator->total_pages - $paginator->current < 5) { ?>
                            <?php $startIndex = $paginator->total_pages - 4; ?>
                        <?php } ?>
                    <?php } ?>
                <nav>
                  <ul class="pagination pagination-no-border">
                    <?php if ($paginator->current > 1) { ?>
                <li><?= $this->tag->linkTo([$controller . '?q=' . $q, 'data-page' => $paginator->first, '<i class="fa fa-angle-double-left"></i>', 'title' => 'Go to page ' . $paginator->next]) ?></li>
                
            <?php } ?>
            <?php foreach (range($startIndex, $paginator->total_pages) as $pageIndex) { ?>
                <?php if ($pageIndex == $startIndex + 5) { ?>
                    <?php break; ?>
                <?php } ?>

                <li <?php if ($pageIndex == $paginator->current) { ?>class="active"<?php } ?>>
                    <?= $this->tag->linkTo([$controller . '?q=' . $q . '&p=' . $pageIndex, $pageIndex, 'data-page' => $pageIndex, 'title' => 'Go to page ' . $pageIndex]) ?>
                </li>
            <?php } ?>
            ...
            <?php if ($paginator->current < $paginator->total_pages) { ?>
                ...
                <li><?= $this->tag->linkTo([$controller . '?q=' . $q . '&p=' . $paginator->last, 'data-page' => $paginator->last, '<i class="fa fa-angle-double-right"></i>', 'title' => 'Go to page ' . $paginator->last]) ?></li>
            <?php } ?>
                  </ul>
                  <?php } ?>
                </nav>
