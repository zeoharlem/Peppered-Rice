    ...
    <div class="container">
        <div class="col-xs-12 no-margin">
            ...
            <div class="billing-address">
                ...
                <form method="post" action="<?= $this->url->get('order/start') ?>" id="billing-form">
                    <div class="row field-row">
                        <div class="col-xs-12 col-sm-6">
                            <label>full name*</label>
                            <input class="le-input" name="firstname" value="<?= $this->session->get('auth')['firstname'] ?>" >
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <label>last name*</label>
                            <input class="le-input" name="lastname"  value="<?= $this->session->get('auth')['lastname'] ?>" />
                        </div>
                    </div><!-- /.field-row -->
                    ...
                    <div class="row field-row">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            ...
                            <input class="le-input" name="email" value="<?= $this->session->get('auth')['email'] ?>" / >
                        </div>

                        <div class="col-xs-12 col-sm-4">
                            <label>phone number*</label>
                            <input class="le-input" name="phonenumber" value="<?= $this->session->get('auth')['phonenumber'] ?>">
                        </div>
                    </div><!-- /.field-row -->
