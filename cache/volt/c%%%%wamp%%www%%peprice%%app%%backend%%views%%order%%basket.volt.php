    ...
    <?= $this->flash->output() ?>
          ...
          <div class="panel" id="followers">
            ...
            <div class="panel-body">
              ...
              <?php $counter=1; ?>
              <?php foreach ($agents['team']->data as $keys => $values) { ?>
                <li class="list-group-item">
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-online" href="javascript:void(0)">
                        <img src="<?= $this->url->get('admin/portraits/' . $counter . '.jpg') ?>" alt="">
                        <i></i>
                      </a>
                    </div>
                    <div class="media-body">
                      ...
                      <div><strong><?= ucwords($values->username) ?></strong></div>
                        ...
                        <ul class="list-group list-group-full hide" id="agent_stack">
                            <li class="list-group-item">
                              <div class="media">
                                <div class="media-left">
                                  <a class="avatar avatar-online" href="javascript:void(0)">
                                    <img class="img-responsive" src="<?= $this->url->get('admin/portraits/5.jpg') ?>"
                                    alt="..."><i></i></a>
                                </div>
                                <div class="media-body">
